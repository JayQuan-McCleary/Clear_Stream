...
class Ecoli100_1_N extends StatefulWidget {
  final List<Widget> pagesToNavigate;
  final int currentIndex;
  const Ecoli100_1_N({super.key, required this.pagesToNavigate, required this.currentIndex});

  @override
  // ignore: library_private_types_in_public_api
  _Ecoli100_1_NState createState() => _Ecoli100_1_NState();
}

// ignore: camel_case_types
class _Ecoli100_1_NState extends State<Ecoli100_1_N> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('E.coli 100-1-N'),
...
class ChemicalEntry extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const Text('ChemicalEntry Widget Placeholder');
  }
}
