...
class ecoli100 extends StatefulWidget {
    final List<Widget> pagesToNavigate;
  final int currentIndex;
  const ecoli100({super.key, required this.pagesToNavigate, required this.currentIndex});

  @override
  // ignore: library_private_types_in_public_api
  _ecoli100State createState() => _ecoli100State();
}

// ignore: camel_case_types
class _ecoli100State extends State<ecoli100> {
