...
class ecoli_100_C extends StatefulWidget {
  final List<Widget> pagesToNavigate;
  final int currentIndex;
  const ecoli_100_C({super.key, required this.pagesToNavigate, required this.currentIndex});

  @override
  // ignore: library_private_types_in_public_api
  _ecoli_100_CState createState() => _ecoli_100_CState();
}

// ignore: camel_case_types
class _ecoli_100_CState extends State<ecoli_100_C> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('E.coli 100-1-C'),
