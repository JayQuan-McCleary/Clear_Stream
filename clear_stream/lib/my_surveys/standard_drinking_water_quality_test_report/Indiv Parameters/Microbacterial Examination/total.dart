...
class TotalColiform extends StatefulWidget {
  final List<Widget> pagesToNavigate;
  final int currentIndex;

  const TotalColiform({super.key, required this.pagesToNavigate, required this.currentIndex});

  @override
  // ignore: library_private_types_in_public_api
  _TotalColiformState createState() => _TotalColiformState();
}

class _TotalColiformState extends State<TotalColiform> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: const Text('Total Coliform Testing Form'),
          automaticallyImplyLeading: false, // Set this to false to remove the back button
        ),
        body: SingleChildScrollView(
            child: Column(children: [
          const Text('Which Total Coliform methods are you using',
