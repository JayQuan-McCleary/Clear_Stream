...
class deep_borehole extends StatefulWidget {
  const deep_borehole({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _ProtectedDeepBoreholeInspectionState createState() =>
      _ProtectedDeepBoreholeInspectionState();
}

class _ProtectedDeepBoreholeInspectionState extends State<deep_borehole> {
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              _buildQuestion(
                  '1. Is there a latrine or sewer within 100 meters of the well?'),
              const SizedBox(height: 10),
              _buildQuestion('2. Is the nearest latrine unsewered?'),
              const SizedBox(height: 10),
              _buildQuestion(
                  '3. Is there any other source of pollution within 50 meters?'),
              const SizedBox(height: 10),
              ...
              const SizedBox(height: 10),
              _buildQuestion('7. Is the floor of the pumphouse permeable to water?'),
              const SizedBox(height: 10),
              _buildQuestion(
                  '8. Does spilled water collect in the pumphouse?'),
              const SizedBox(height: 10),
              _buildQuestion('9. Is the well seal unsanitary?'),
              const SizedBox(height: 10),
              const Text(
                'Comments on Deep Borehole with mechanized pumping Sanitary Inspection',
