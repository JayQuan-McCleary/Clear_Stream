...
void main() {
  runApp(const MaterialApp(
    home: WaterPointDowntime(),
  ));
}

class WaterPointDowntime extends StatefulWidget {
  const WaterPointDowntime({super.key});

  @override
  _WaterPointDowntimeState createState() => _WaterPointDowntimeState();
}

class _WaterPointDowntimeState extends State<WaterPointDowntime> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: const Text('Waterpoint Downtime issue'),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      const Text('Date problem was reported'),
                      const SizedBox(height: 5),
                      ElevatedButton(
                        onPressed: () {
                          // Show Date Picker
                      ...
                      const SizedBox(height: 10),
                      Text('$selectedDate2'),
                      const Text('Date problem was identified'),
                      const SizedBox(height: 5),
                      ElevatedButton(
                        onPressed: () {
                          // Show Date Picker
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      RadioListTile<String>(
                        title: const Text('Insufficient Water Supplied'),
                        value: 'Insufficient Water Supplied',
                        groupValue: selectedIssueType,
                        onChanged: (value) {
                          setState(() {
                            selectedIssueType = value!;
                      ...
                      RadioListTile<String>(
                        title: const Text('Poor Water Quality'),
                        value: 'Poor Water Quality',
                        groupValue: selectedIssueType,
                        onChanged: (value) {
                          setState(() {
                            selectedIssueType = value!;
                      ...
                      RadioListTile<String>(
                        title: const Text('Theft or Vandalism'),
                        value: 'Theft or Vandalism',
                        groupValue: selectedIssueType,
                        onChanged: (value) {
                          setState(() {
                            selectedIssueType = value!;
