...
void main() {
  runApp(const MaterialApp(
    home: WaterpointFunctionality(),
  ));
}

class WaterpointFunctionality extends StatefulWidget {
  const WaterpointFunctionality({super.key});

  @override
  _WaterpointFunctionalityState createState() =>
      _WaterpointFunctionalityState();
}

class _WaterpointFunctionalityState extends State<WaterpointFunctionality> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: const Text('Water Point functionality issue'),
